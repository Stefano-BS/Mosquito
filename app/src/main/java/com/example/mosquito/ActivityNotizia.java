...
public class ActivityNotizia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.visita_pagina_notizia).setOnClickListener(click -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(n.link))));
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_NO) {
            stile = "<style>* {background-color: white; color: black;} h1 {font-size: 4em;} h2 {font-size: 3em;} html {font-size: 2.5em;}</style> ";
            findViewById(R.id.scrollview_notizia_activity).setBackgroundColor(getColor(R.color.white));
        }
        else if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            stile = "<style>* {background-color: black; color: white;} h1 {font-size: 4em;} h2 {font-size: 3em;} html {font-size: 2.5em;</style> ";
